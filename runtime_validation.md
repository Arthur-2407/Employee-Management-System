...
**Timestamp**: 2026-06-21T18:15:14.055Z
**Overall Status**: PASS
...
- **TIMESTAMP**: 2026-06-21T18:14:48.506Z
- **ROUTE**: GET /health
- **API CALLED**: http://localhost/health
- **REQUEST**: `None`
- **RESPONSE**: `{"status":"healthy","timestamp":"2026-06-21T18:14:48.500Z","version":"1.0.0","services":{"database":"connected","redis":"connected","ai-service":"connected"},"circuitBreakers":{"database":{"state":"CLOSED","failures":0,"failureThreshold":5,"totalCall...`
...
- **TIMESTAMP**: 2026-06-21T18:14:50.357Z
...
- **TIMESTAMP**: 2026-06-21T18:14:50.925Z
- **ROUTE**: POST /api/auth/bootstrap/setup
- **API CALLED**: http://localhost/api/auth/bootstrap/setup
- **REQUEST**: `{"password":"SecureAdminPassword123!","frames":["BiX6J9xe/SWU3rqhWWaMOW5XOmkpo18ItK45Ino5GNHxLjfEFy8qjVE13X1n9d3sh52WZV03HgbrkBdkgwbl8UfnbfNlgwVeWIlvF...`
...
- **TIMESTAMP**: 2026-06-21T18:15:13.017Z
- **ROUTE**: GET /api/auth/bootstrap/status
- **API CALLED**: http://localhost/api/auth/bootstrap/status
- **REQUEST**: `None`
...
- **TIMESTAMP**: 2026-06-21T18:15:13.098Z
...
- **TIMESTAMP**: 2026-06-21T18:15:13.389Z
- **ROUTE**: POST /api/auth/face-login
- **API CALLED**: http://localhost/api/auth/face-login
- **REQUEST**: `{"employeeId":"admin","password":"SecureAdminPassword123!","frames":["BiX6J9xe/SWU3rqhWWaMOW5XOmkpo18ItK45Ino5GNHxLjfEFy8qjVE13X1n9d3sh52WZV03HgbrkBdk...`
...
- **TIMESTAMP**: 2026-06-21T18:15:13.483Z
...
- **RESPONSE**: `{"success":true,"data":{"id":281,"employee_id":"EMP_TEST001","first_name":"Test","last_name":"Employee","email":"test.employee@attendance-system.local","role":"employee"},"message":"Employee created successfully"}`
...
- **TIMESTAMP**: 2026-06-21T18:15:13.549Z
- **ROUTE**: POST /api/auth/login
- **API CALLED**: http://localhost/api/auth/login
- **REQUEST**: `{"employeeId":"EMP_TEST001","password":"TestPass123"}`
- **RESPONSE**: `{"success":true,"message":"Login successful","tokens":{"accessToken":"eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6MjgxLCJlbXBsb3llZUlkIjoiRU1QX1RFU1QwMDEiLCJlbWFpbCI6InRlc3QuZW1wbG95ZWVAYXR0ZW5kYW5jZS1zeXN0ZW0ubG9jYWwiLCJyb2xlIjoiZW1wbG95ZWUiLCJkZXB...`
...
- **TIMESTAMP**: 2026-06-21T18:15:13.840Z
...
- **TIMESTAMP**: 2026-06-21T18:15:13.859Z
- **ROUTE**: POST /api/auth/face-login
- **API CALLED**: http://localhost/api/auth/face-login
- **REQUEST**: `{"employeeId":"EMP_TEST001","frames":["iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII=","iVBORw0KGgoAAAAN...`
- **RESPONSE**: `{"success":true,"authenticated":true,"message":"Authentication successful","tokens":{"accessToken":"eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6MjgxLCJlbXBsb3llZUlkIjoiRU1QX1RFU1QwMDEiLCJlbWFpbCI6InRlc3QuZW1wbG95ZWVAYXR0ZW5kYW5jZS1zeXN0ZW0ubG9jYWwiL...`
- **DATABASE EFFECT**: Insert login_logs, update employees last_login_at
- **SCREEN RESULT**: Employee Redirected to Dashboard
- **PASS/FAIL**: PASS
...
- **TIMESTAMP**: 2026-06-21T18:15:14.026Z
- **ROUTE**: POST /api/auth/face-login
- **API CALLED**: http://localhost/api/auth/face-login
- **REQUEST**: `{"employeeId":"EMP_TEST001","frames":["BiX6J9xe/SWU3rqhWWaMOW5XOmkpo18ItK45Ino5GNHxLjfEFy8qjVE13X1n9d3sh52WZV03HgbrkBdkgwbl8UfnbfNlgwVeWIlvFKGxKR5COkY...`
- **RESPONSE**: `{"success":true,"authenticated":true,"message":"Authentication successful","tokens":{"accessToken":"eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6MjgxLCJlbXBsb3llZUlkIjoiRU1QX1RFU1QwMDEiLCJlbWFpbCI6InRlc3QuZW1wbG95ZWVAYXR0ZW5kYW5jZS1zeXN0ZW0ubG9jYWwiL...`
- **DATABASE EFFECT**: Insert login_logs, update employees last_login_at
- **SCREEN RESULT**: Employee Redirected to Dashboard
- **PASS/FAIL**: PASS
